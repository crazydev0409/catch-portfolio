        ...
        <div className="grid gap-16 md:grid-cols-2 md:items-center">
          ...
          >
            ...
            <p className="mt-4 text-[#8B949E]">
              The system evaluates multiple signals including:
            </p>
            <ul className="mt-4 space-y-2">
              {SIGNALS.map((signal, i) => (
                <li key={signal} className="flex items-center gap-2 text-[#8B949E]">
          ...
          >
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between border-t border-[#30363D] pt-4">
                ...
                <span className="text-2xl font-semibold text-[#4F7CFF]">92%</span>
              </div>
            </div>
            <div className="mt-6 h-2 overflow-hidden rounded-full bg-[#0B0F14]">
              <motion.div
                initial={{ width: 0 }}
